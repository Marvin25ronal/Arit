 ...
 * @author marvi
 */
public class Median implements Expresion {

    LinkedList<Expresion> exp;
    LinkedList<Expresion> dimensiones;
    int linea, columna;

    public Median(LinkedList<Expresion> exp, LinkedList<Expresion> dimensiones, int linea, int columna) {
        this.exp = exp;
                ...
                if (vector.getTiposecundario().esNumero()) {
                    if (ttrim.isVector()) {
                        ...
                        if (vtrim.getTiposecundario().esNumero()) {
                            ...
                            return HacerMediana(e, vector, valortrim);
                        } else {
    ...
    private Object HacerMediana(Entorno e, EstructuraLineal v, double trim) {
        double res = 0;
    ...
    private Object HacerMediana(Entorno e, EstructuraLineal v) {
        double res = 0;
        LinkedList<Double> datos = new LinkedList<>();
        for (Object l : v.getDimensiones()) {
            Literal aux = (Literal) l;
