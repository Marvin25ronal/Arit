...
public class nCol implements Expresion {
    ...
    public nCol(LinkedList<Expresion> exp, LinkedList<Expresion> dimensiones, int linea, int columna) {
        this.exp = exp;
    ...
    public Object getValor(Entorno e) {
        ...
        if (t.isMatrix()) {
            Matrix m = (Matrix) res;
            EstructuraLineal nueva = new EstructuraLineal(new TipoExp(Tipos.INTEGER), m.getColumna(), linea, columna);
